...
prober_res_dir = "prober_result" # path to result TSV file generated by barapost-v3-4a.py
...
# |=== Function for configuring dictionary containing information generated by barapost-v3-4a.py ===|
...
def get_res_tsv_fpath(new_dpath):
    ...
    file '{}...' have been processed by 'barapost-v3-4a.py'""".format(os.path.basename(new_dpath)))
    ...
    with how_to_open(fq_fa_path) as source_fastq_file:
        ...
        for i in range(num_reads):
            ...
            try:
                ...
                printl("Make sure that this read has been already processed by 'prober.py' and 'barapost-v3-4a.py'.")
                continue
