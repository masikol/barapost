...
prober_res_dir = "barapost_result" # path to result TSV file generated by barapost-v3-5f.py
...
'{}'\n  basecaling has been processed by 'prober-v1-12f.py' and 'barapost-v3-5f.py'.
...
but this error still occurs, then you should contact the developer.\n""")
    ...
    '{}' does not exist.""".format(os.path.basename(fpath)))
            print("Please, make sure that this file have been already processed by 'prober-v1-12f.py' and 'barapost-v3-5f.py'.")
            platf_depend_exit(1)
    # end if
# end for
...
# |=== Function for configuring dictionary containing information generated by barapost-v3-5f.py ===|
...
def get_res_tsv_fpath(new_dpath):
    ...
    '{}...'
    with 'prober-v1-12f.py' 'barapost-v3-5f.py'""".format(os.path.basename(new_dpath)))
        printl("""Also this error might occur if you forget to specify result directory
    generated by 'prober-v1-12f.py' with '-r' option.""")
        platf_depend_exit(0)
    # end if
    ...
    with how_to_open(fq_fa_path) as source_fastq_file:
        ...
        for i in range(num_reads):
            ...
            try:
                ...
                printl("Make sure that this read has been already processed by 'prober-v1-12f.py' and 'barapost-v3-5f.py'.")
                platf_depend_exit(1)
