...
if "-h" in sys.argv[1:] or "--help" in sys.argv[1:]:
  ...
  generated by "barapost-prober.py" and creates a database on local machine. After that "baraposst.py" classifies
...
if not db_exists:
    ...
    if not acc_file_exists and len(your_own_fasta_lst) == 0 and len(accs_to_download) == 0:
        ...
        print(err_fmt("cannot create a database. Reasons:"))
