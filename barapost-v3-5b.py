...
DESCRIPTION:\n
 ...
 'barapost-v3.5a.py' is meant to be used just after 'prober-v1-12c.py'.
...
of work of 'prober-v1-12c.py' script, build an indexed local database which consists of
...
try:
    opts, args = getopt.gnu_getopt(argv[1:], "hd:o:p:a:r:l:t:",
...
# end if
    ...
    if prober_res_dir == "prober_result":
        print("""Maybe, output directory generated by 'prober-v1-12c.py' hasn't been named 'prober_result'
...
logfile.write((" |=== barapost-v3-5b.py ===|\n\n"))
...
def launch_blastn(packet, blast_algorithm):
    ...
    # In order to provide full cli-interface compatibility with 'prober-v1-12c.py' I will merely change values here.
...
def get_curr_res_dir(fq_fa_path, prober_res_dir):
    ...
    :type fq_fa_path: str;
    :param prober_res_dir: path to directory with results of 'prober-v1-12c.py';
    :type prober_res_dir: str;
...
def configure_acc_dict(acc_fpath):
    """
    Fucntion couffigures accession dictionary according to accessin file generated by 'prober-v1-12c.py':
       keys are accessions, values are tuples of the following format:
        (<GI_number>, <sequence_name_aka_definition>).

    :param acc_fpath: path to accession file generated by 'prober-v1-12c.py';
    :type acc_fpath: str;
