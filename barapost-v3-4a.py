...
of work of 'prober-v1-11a.py' script, build an indexed local database which consists of
...
OPTIONS:\n
    ...
    -r (--prober-result-dir) --- result directory genearted by script 'prober-v1-11a.py'
...
if not os.path.exists(prober_res_dir) and len(your_own_fasta_lst) == 0:
    ...
    if prober_res_dir == "prober_result":
        print("""Maybe, output directory generated by 'prober-v1-11a.py' hasn't been named 'prober_result'
...
def launch_blastn(packet, blast_algorithm):
    ...
    # In order to provide full cli-interface compatibility with 'prober-v1-11a.py' I will merely change values here.
...
def get_curr_res_dir(fq_fa_path, prober_res_dir):
    ...
    :type fq_fa_path: str;
    :param prober_res_dir: path to directory with results of 'prober-v1-11a.py';
    :type prober_res_dir: str;
...
def configure_acc_dict(acc_fpath):
    """
    Fucntion couffigures accession dictionary according to accessin file generated by 'prober-v1-11a.py':
       keys are accessions, values are tuples of the following format:
        (<GI_number>, <sequence_name_aka_definition>).

    :param acc_fpath: path to accession file generated by 'prober-v1-11a.py';
    :type acc_fpath: str;
