...
if "-h" in sys.argv[1:] or "--help" in sys.argv[1:]:
    ...
    print("DESCRIPTION:\n")
    print("""This script is designed for taxonomic classification of nucleotide sequences by "BLASTing"
  ...
  generated by "prober.py", creates a database (on your local machine) which consists of downloaded
  sequences, and continues aligning the rest of your data with "BLAST+" toolkit.\n""")
        print("Script processes FASTQ and FASTA (as well as '.fastq.gz' and '.fasta.gz') files.\n")
        print("\"barapost.py\" appends it's results in the same TSV file as \"prober.py\" does.\n")
        print("Files processed by this script are meant to be sorted afterwards by 'fastQA5-sorter.py'.\n")
  ...
  positional arguments (see EXAMPLE #2 running detailed (--help) help message).""")
   ...
   barapost.py\n""")
        print("""2. Process all files in the working directory that start with "some_fasta". Use default settings:\n
