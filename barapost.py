...
help_msg = """
  ...
  Version {}; {} edition;\n
DESCRIPTION:\n
This script is designed for taxonomic annotation of nucleotide sequences by "BLASTing"
...
"barapost.py" downloads records-hits from Genbank according to results (`...probe_acc_list.tsv`)
...
If you have your own FASTA files that can be used as database to blast against,
...
OPTIONS:\n
    ...
    -r (--taxannot-resdir) --- result directory generated by script 'prober.py'
...
EXAMPLES:\n
  ...
  6. Process file named 'some_reads.fastq'. This file has been already processed by "prober.py".
     Results of "prober.py" work are in directory 'prober_outdir'.
    ...
    for i, fq_fa_path in enumerate(fq_fa_list):
        ...
        if num_done_reads == curr_fasta["nreads"]:
            if not parallel:
                ...
                with print_lock:
                    logfile.write("File '{}' has been already completely processed.\n".format(fq_fa_path))
