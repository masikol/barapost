...
3. **fastQA-sorter-v2-7a.py** -- this program performs sorting (dividing into separate files) of your data set according to results of "prober-v1-9a.py" and "barapost-v3-3a.py"
...
`./prober-v1-9a.py && ./barapost-v3-3a.py && ./fastQA-sorter-v2-7a.py`
